...
object PlayerFieldProtocol {
  ...
  def convert(game: PlayerField): PlayerFieldProtobuf.PlayerField = {
    val ProtoField3000 = PlayerFieldProtobuf.PlayerField
      .newBuilder()
  ...
  def convert(game: PlayerFieldProtobuf.PlayerField): PlayerField = {
